	...
	<div class="container-fluid">
		...
		<div class="box box-bordered bordered-top">
			<div class="box-content nopadding">																
				<form id="mainForm" action="${pageContext.servletContext.contextPath}/sysback/storemanage/update" method="post" class='form-horizontal form-bordered form-validate1'>
