 ...
 *
 */
public class FreePatchUtil2 {
	    
		/* 更新前是否删除原文件  true:删除    false:不删除 */
		public static boolean isDelete = true;

		public static String projectNoDirPath = "/anxun/centerMgr/";//从SVN更新下来在src目录之前的项目路径
    	
	    public static String patchFile="D:/longwork/addValueFile/patch.txt";//将SVN更新下来的文件记录保存为patch.txt
        
	    public static String projectPath="D:/longwork/anxun/centerMgr";
	    
	    public static String webContent="src/main/webapp";//web应用文件夹名  
	      
	    public static String classPath="D:/longwork/anxun/centerMgr/target/classes";//class存放路径 
	      
	    public static String desPath="D:/longwork/addValueFile";//补丁文件包存放路径  
	      
	    public static String version="2016";//补丁版本   
