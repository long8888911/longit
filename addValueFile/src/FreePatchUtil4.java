 ...
 *
 */
public class FreePatchUtil4 {
	    
		/* 更新前是否删除原文件  true:删除    false:不删除 */
		public static boolean isDelete = true;

		public static String projectNoDirPath = "/Bellavita/trunk/pc";//从SVN更新下来在src目录之前的项目路径
    	
	    public static String patchFile="D:/longwork/addValueFile/patch.txt";//将SVN更新下来的文件记录保存为patch.txt
        
	    public static String projectPath="D:/longwork/Bellavita/trunk/pc";
	    
	    public static String webContent="src/main/webapp";//web应用文件夹名  
	      
	    public static String classPath="D:/longwork/Bellavita/trunk/pc/target/classes";//class存放路径
	      
	    public static String desPath="D:/longwork/addValueFile";//补丁文件包存放路径  
	      
	    public static String version="2018";//补丁版本
